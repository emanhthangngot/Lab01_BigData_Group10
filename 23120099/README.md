...
- `docs/23120099_verification.txt`: thông tin xác thực môi trường máy chạy bài.

## Dữ liệu đầu vào/đầu ra
- Input HDFS (theo mã nguồn): `hdfs://localhost:9000/hcmus/23120099/words.txt`
- Output HDFS: `hdfs://localhost:9000/hcmus/23120099/output_wordcount`
...
- Lỗi thiếu file input trên HDFS:
  - Upload lại bằng `hdfs dfs -put words.txt /hcmus/23120099/`.
