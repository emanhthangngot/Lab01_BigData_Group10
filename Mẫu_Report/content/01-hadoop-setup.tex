...
việc lập trình WordCount bằng Hadoop MapReduce ở phần sau, tận dụng khả năng lập trình
hàm và cú pháp ngắn gọn của Scala cho API MapReduce thay vì Java thuần.
